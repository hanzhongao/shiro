...
%>
${errors == 'org.apache.shiro.authc.UnknownAccountException'          ? "未知账户异常" : ""}
${errors == 'org.apache.shiro.authc.IncorrectCredentialsException'    ? "错误的用户名或密码" : ""}
${errors == 'org.apache.shiro.authc.LockedAccountException'           ? "账号已锁定" : ""}
${errors == 'com.hza.ssm.filter.authc.exceptrion.RandomCodeException' ?"验证码输入错误！" : ""}
${errors == 'org.apache.shiro.authc.ExcessiveAttemptsException'       ?"密码尝试次数过多" : ""}
