...
public class ShiroAuthorizationRedisConfig {
    ...
    @Bean("shiroAuthorizationlettuceClientConfiguration")
    ...
    public RedisConnectionFactory getConnectionFactory(
            ...
            @Autowired LettuceClientConfiguration shiroAuthorizationlettuceClientConfiguration
    ) {
        LettuceConnectionFactory connectionFactory = new LettuceConnectionFactory(shiroAuthorizationRedisConfiguration,shiroAuthorizationlettuceClientConfiguration) ;
