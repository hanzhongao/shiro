...
public class ShiroSessionRedisConfig {
    ...
    @Bean("shiroSessionlettuceClientConfiguration")
    ...
    public RedisConnectionFactory getConnectionFactory(
            ...
            @Autowired LettuceClientConfiguration shiroSessionlettuceClientConfiguration
    ) {
        LettuceConnectionFactory connectionFactory = new LettuceConnectionFactory(shiroSessionRedisConfiguration,shiroSessionlettuceClientConfiguration) ;
