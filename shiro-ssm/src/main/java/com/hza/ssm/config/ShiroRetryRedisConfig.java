...
public class ShiroRetryRedisConfig {
    ...
    @Bean("shiroRetrylettuceClientConfiguration")
    ...
    public RedisConnectionFactory getConnectionFactory(
            ...
            @Autowired LettuceClientConfiguration shiroRetrylettuceClientConfiguration
    ) {
        LettuceConnectionFactory connectionFactory = new LettuceConnectionFactory(shiroRetryRedisConfiguration,shiroRetrylettuceClientConfiguration) ;
