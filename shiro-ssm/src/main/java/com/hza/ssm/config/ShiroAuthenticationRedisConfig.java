...
public class ShiroAuthenticationRedisConfig {
    ...
    @Bean("shiroAuthenticationlettuceClientConfiguration")
    ...
    public RedisConnectionFactory getConnectionFactory(
            ...
            @Autowired LettuceClientConfiguration shiroAuthenticationlettuceClientConfiguration
    ) {
        LettuceConnectionFactory connectionFactory = new LettuceConnectionFactory(shiroAuthenticationRedisConfiguration,shiroAuthenticationlettuceClientConfiguration) ;
